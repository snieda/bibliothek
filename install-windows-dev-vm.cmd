...
# Tools
choco install wget curl netcat openssh openvpn nmap tightvnc
choco install fzf fd lf mc less bat 7zip vim googler ripgrep-all
choco install gnupg
choco install make
choco install cmake.portable
choco install msys2-installer
curl https://dystroy.org/broot/download/x86_64-windows/broot -O ~/bin/broot && chmod a+x ~/bin/broot
...
# Languages
choco install jdk8 maven gradle
choco install jdk11
...
choco install kitty, winscp.portable
